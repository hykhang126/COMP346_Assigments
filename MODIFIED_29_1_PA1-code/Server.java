...
public class Server extends Thread {
     ...
     */
     ...
     {   int accIndex;             	/* Index position of account to update */
         ...
         { 
        	 while( (objNetwork.getInBufferStatus().equals("empty")) && objNetwork.getClientSenderStatus())
        	 {
        		 System.out.println("\n --- Server yielding cos InBuffer empty && ClientSender true ---");
        		 Thread.yield();
        	 ...
        	 if (!objNetwork.getInBufferStatus().equals("empty"))
        	 {
        		 ...
        		 {
        			 System.out.println("\n --- Server yielding cos OutBuffer full --- ");
        			 Thread.yield();
