...
public class Network extends Thread {
    ...
    private static boolean clientSenderStatus;
    ...
    {	    	
    	...
    	while (true)
    	{
            ...
            if (getClientConnectionStatus().equalsIgnoreCase("disconnected") 
            		&& getServerConnectionStatus().equalsIgnoreCase("disconnected"))
            {
	...
	public boolean getClientSenderStatus() {
		return clientSenderStatus;
	}

	public void setClientSenderStatus(boolean clientSenderStatus) {
		Network.clientSenderStatus = clientSenderStatus;
	}
}
